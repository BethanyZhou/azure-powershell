...
New-AzDiskPool -Name <String> -ResourceGroupName <String> -AvailabilityZone <String[]> -Location <String>
 -SubnetId <String> -Tier <String> [-SubscriptionId <String>] [-AdditionalCapability <String[]>]
 [-DiskId <String[]>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
