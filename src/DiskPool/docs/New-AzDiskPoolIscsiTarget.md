...
online version: https://docs.microsoft.com/powershell/module/diskpool/new-azdiskpooliscsitarget
schema: 2.0.0
---
...
New-AzDiskPoolIscsiTarget -DiskPoolName <String> -Name <String> -ResourceGroupName <String>
 -Tpg <ITargetPortalGroupCreate[]> [-SubscriptionId <String>] [-TargetIqn <String>]
...
Can have 1 portal group at most.
...
TPG <ITargetPortalGroupCreate[]>: List of iSCSI target portal groups. Can have 1 portal group at most.
