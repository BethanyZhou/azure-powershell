...
online version: https://docs.microsoft.com/powershell/module//az.DiskPool/new-AzDiskPoolTargetPortalGroupCreateObject
schema: 2.0.0
---

# New-AzDiskPoolTargetPortalGroupCreateObject
...
```
New-AzDiskPoolTargetPortalGroupCreateObject -Acl <IAcl[]> -AttributeAuthentication <Boolean>
...
ACL <IAcl[]>: Access Control List (ACL) for an iSCSI target portal group.
