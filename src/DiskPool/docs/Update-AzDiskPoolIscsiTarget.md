...
```
Update-AzDiskPoolIscsiTarget -InputObject <IDiskPoolIdentity> -Tpg <ITargetPortalGroupUpdate[]>
...
TPG <ITargetPortalGroupUpdate[]>: List of iSCSI target portal groups. Can have 1 portal group at most.
