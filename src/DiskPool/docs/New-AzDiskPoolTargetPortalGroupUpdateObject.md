...
online version: https://docs.microsoft.com/powershell/module//az.DiskPool/new-AzDiskPoolTargetPortalGroupUpdateObject
schema: 2.0.0
---
...
```
New-AzDiskPoolTargetPortalGroupUpdateObject [-Acl <IAcl[]>] [-Lun <IIscsiLun[]>] [<CommonParameters>]
```
