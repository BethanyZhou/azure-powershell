...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Models.Api20200315Preview.IDiskPool
.Notes
COMPLEX PARAMETER PROPERTIES

To create the parameters described below, construct a hash table containing the appropriate properties. For information on hash tables, run Get-Help about_Hash_Tables.

DISK <IDisk[]>: List of Azure Managed Disks to attach to a Disk pool. Can attach 8 disks at most.
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Models.Api20200315Preview.IDiskPool])]
...
param(
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Models.Api20200315Preview.IDiskPoolUpdateTags]))]
        ...
        try {
            if ($PSBoundParameters.ContainsKey("DiskId")){
                ...
                for ($i = 0; $i -lt $DiskId.Count; $i++) {
                    $diskObject= [Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Models.Api20200315Preview.Disk]::New()
