...
function New-AzDiskPoolAclObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Models.Api20200315Preview.Acl')]
    [CmdletBinding(PositionalBinding=$false)]
    Param(

        [Parameter(HelpMessage="Password for Challenge Handshake Authentication Protocol (CHAP) authentication.")]
        [System.Security.SecureString]
        $CredentialsPassword,
        [Parameter(HelpMessage="Username for Challenge Handshake Authentication Protocol (CHAP) authentication.")]
        [string]
        $CredentialsUsername,
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Models.Api20200315Preview.Acl]::New()
        ...
        $Object.CredentialsPassword = $psTxt
